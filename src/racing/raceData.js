...
export function createDefaultCar(id = 'starter-rwd') {
  const templates = {
    'starter-rwd': {
      ...
      defaultTransmissionType: 'manual',
      engineProfile: 'wrx-flat-four-manual'
    },
    'wrx-2022-automatic': {
      id: 'starter-rwd',
...
const TURINI_POINTS = [
  ...
  { x: 0.16, y: -0.35, elevation: -0.24 },
  { x: -0.08, y: -0.68, elevation: -0.1 },
  { x: 0.22, y: -0.94, elevation: 0.02 },
  { x: -0.12, y: -1.2, elevation: 0.16 },
  { x: 0.26, y: -1.46, elevation: 0.3 },
  { x: -0.02, y: -1.78, elevation: 0.42 },
  { x: 0.34, y: -2.08, elevation: 0.36 },
  { x: 0.08, y: -2.44, elevation: 0.18 },
  { x: 0.44, y: -2.75, elevation: 0.02 },
  { x: 0.2, y: -3.05, elevation: -0.08 },
  { x: 0.58, y: -3.32, elevation: -0.18 }
];

const TURINI_SEGMENTS = [
  { curve: 0.85, surface: 'asphalt', turn: 'square', codriver: 'turini-hairpin-1' },
  { curve: -0.88, surface: 'asphalt', turn: 'square' },
  { curve: 0.82, surface: 'asphalt', turn: 'square' },
  { curve: -0.86, surface: 'wet-asphalt', turn: 'square', codriver: 'turini-climb' },
  { curve: 0.9, surface: 'wet-asphalt', turn: 'square' },
  { curve: -0.72, surface: 'snow', turn: 'square', codriver: 'turini-snowline', hazardIds: ['turini-ice-patch'] },
  { curve: 0.74, surface: 'snow', turn: 'square' },
  { curve: -0.82, surface: 'snow', turn: 'square' },
  { curve: 0.8, surface: 'wet-asphalt', turn: 'square', codriver: 'turini-descent' },
  { curve: -0.64, surface: 'wet-asphalt' },
  { curve: 0.32, surface: 'asphalt' }
];

const OUNINPOHJA_POINTS = [
  { x: 0, y: 0, elevation: -0.18 },
  { x: 0.42, y: -0.55, elevation: -0.1 },
  { x: 0.15, y: -1.22, elevation: -0.02 },
  { x: 0.68, y: -1.82, elevation: 0.08 },
  { x: 1.18, y: -2.36, elevation: 0.18 },
  { x: 0.9, y: -3.0, elevation: 0.26 },
  { x: 1.42, y: -3.64, elevation: 0.2 },
  { x: 1.18, y: -4.28, elevation: 0.12 },
  { x: 1.72, y: -4.9, elevation: 0.24 },
  { x: 1.48, y: -5.55, elevation: 0.18 },
  { x: 2.08, y: -6.12, elevation: 0.06 },
  { x: 1.85, y: -6.74, elevation: -0.04 }
];

const OUNINPOHJA_SEGMENTS = [
  { curve: 0.28, surface: 'gravel', codriver: 'ounin-fast' },
  { curve: -0.34, surface: 'gravel', hazardIds: ['ounin-yellow-house-jump'] },
  { curve: 0.24, surface: 'gravel' },
  { curve: 0.18, surface: 'gravel', hazardIds: ['ounin-crest-jump-1'] },
  { curve: -0.3, surface: 'gravel' },
  { curve: 0.22, surface: 'gravel', codriver: 'ounin-max-attack', hazardIds: ['ounin-crest-jump-2'] },
  { curve: -0.18, surface: 'gravel' },
  { curve: 0.26, surface: 'gravel', hazardIds: ['ounin-long-jump'] },
  { curve: -0.22, surface: 'gravel' },
  { curve: 0.2, surface: 'gravel' },
  { curve: -0.28, surface: 'gravel', codriver: 'ounin-finish' }
];
