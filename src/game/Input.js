...
export default class Input {
  ...
  updateGamepad() {
    ...
    const nextActions = {
      ...
      gamepadA: isButtonActive(0),
      gamepadB: isButtonActive(1),
      gamepadX: isButtonActive(2),
      gamepadY: isButtonActive(3),
      gamepadSelect: isButtonActive(8),
      gamepadStart: isButtonActive(9),
